    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-[680px] mx-auto">
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside text-lg text-[var(--color-text-secondary)] space-y-2 leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <ul className="list-none text-lg text-[var(--color-text-secondary)] space-y-2 mt-4 leading-relaxed">
            <li>📧 Email: hello@novascribe.dev</li>
            <li>🐙 GitHub: <a href="https://github.com/novascribe" className="text-[var(--color-primary)] hover:underline">@novascribe</a></li>
            <li>🐦 Twitter: <a href="https://twitter.com/novascribe" className="text-[var(--color-primary)] hover:underline">@novascribe</a></li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-lg text-[var(--color-text-secondary)] leading-relaxed">
            您可以透過 <a href="/feed.xml" className="text-[var(--color-primary)] hover:underline">RSS Feed</a> 訂閱本部落格的最新文章，或是在社群媒體上關注我們以接收即時更新。
          </p>
        </section>
      </div>
    </div>
